    ...
    <section class="h-full">
        ...
        <section class="mx-auto max-w-[2000px] min-w-[280px] py-8 px-4 h-full sm:px-8 md:px-10 lg:0px-20" ng-show="mode === 'eszkozok'">
            ...
            xl:px-16">
                ...
                <img class="w-full max-w-[280px] rounded-[50px] ml-0 sm:max-w-[320px] md:max-w-[360px] lg:max-w-[400px] lg:ml-6 lg:order-2 xl:max-w-[410px] hidden sm:block"
                ...
                <div class="text-center md:text-left">
                    ...
                    <button class="w-full max-w-[350px] text-xl font-bold rounded-[38px] bg-[#5A7863] text-white py-4 px-6 sm:px-9 hidden sm:block">
        ...
        <section class="mx-auto max-w-[2000px] min-w-[280px] py-8 px-4 h-full sm:px-8 md:px-10 lg:0px-20" ng-show="mode === 'atvalto'">
            ...
            xl:max-w-[410px] hidden sm:block"
