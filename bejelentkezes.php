...
<head>
  ...
  <title>Belépés és regisztráció</title>
          ...
          <div class="bg-white rounded-2xl shadow-xl p-8">
            ...
            <form @submit.prevent="handleSubmit">
              ...
              <div class="mb-6">
                ...
                <p x-show="password && !validatePassword(password)" class="mt-2 text-sm text-red-600">A jelszónak legalább 8 karakter hosszúnak kell lennie</p>
              </div>

              <!-- Confirm Password Field (Register only) -->
              <div x-show="!isLogin" class="mb-6 transition-all duration-300 ease-out">
                <label class="block text-sm font-medium text-gray-700 mb-2">Jelszó mégegyszer</label>
                <div class="relative">
                  <input
                ...
                <p x-show="confirmPassword && !validateConfirmPassword()" class="mt-2 text-sm text-red-600">Nem egyezik a két jelszó</p>
              </div>
