...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2026. Már 27. 11:08
...
(1, 'asd', 'asd', 'TejbeTök', 'asd@gmail.com', '$2y$10$rUJz1e8yZomrGIhFktthse9hhGcrQo.jNdVDlEjAYxPy/uspJfeYa', '1999', '', 20, '2026', 1420, 1),
...
(6, 'Keresztúri', 'Hanna', 'Kerhanna', 'kerhanna05@gmail.com', '$2y$10$9duKM/SEYlqcOLdJ0crxDe3gQ5tJsmwpSxCVaSfCS1ZA15qMtks0S', '2005', '', 1, '2026', 35, 2),
...
(17, 'Molnár', 'Andor', 'nemfogokcsalni5', 'nemfogokcsalni5@gmail.com', '$2y$10$o6CdRc8VdP6CWZBxa8c2legOTRVr4rlzAqrtd80r7H90A9/TwyAB.', '2005', '', 14, '2026', 130, 2),
(19, 'Pádár', 'Zsolt', 'zsoltikv', 'fosdomb@gmail.com', '$2y$10$s/gFvs6YVc065G7eVkRgJu9791kCeEIEx54CLmlkKHWmQTmDVUDAK', '2005', 'assets/kepek/profilKepek/user_19_1774426291.webp', 1, '2026', 180, 2);
...
(18, 'zellergumó', NULL),
(19, 'vöröshagyma', NULL),
(20, 'petrezselyem', NULL),
(21, 'babérlevél', NULL),
(22, 'egész bors', NULL),
(23, 'víz', NULL),
(24, 'őrölt kömény', NULL),
(25, 'pirospaprika', NULL),
(26, 'ecet', NULL),
(27, 'sertés karajcsont', NULL),
(28, 'csigatészta', NULL),
(29, 'paradicsomlé', NULL),
(30, 'sűrített paradicsom', NULL),
(31, 'betűtészta', NULL),
(32, 'darált háztartási keksz', NULL),
(33, 'habtejszín', NULL),
(34, 'porcukor', NULL),
(35, 'vaníliás cukor', NULL),
(36, 'kakaópor', NULL),
(37, 'mascarpone', NULL),
(38, 'babapiskóta', NULL),
(39, 'kávé', NULL),
...
(49, 'bors', NULL),
(50, 'sertéskaraj', NULL),
(51, 'zsemlemorzsa', NULL),
(52, 'étolaj', NULL),
(53, 'spagetti', NULL),
(54, 'paradicsomszósz', NULL),
(55, 'főtt sonka', NULL),
(56, 'trappista sajt', NULL),
(57, 'gomba', NULL),
(58, 'száraztészta', NULL),
(59, 'karfiol', NULL),
(60, 'sütőpor', NULL),
(61, 'csokicsepp', NULL),
(62, 'kolbász', NULL),
...
(72, 'paradicsom', NULL),
(73, 'csirkecomb', NULL),
(74, 'reszelt sajt', NULL),
(75, 'sonka', NULL),
(76, 'zöldség (paprika vagy hagyma)', NULL),
(77, 'étcsokoládé', NULL),
(78, 'egész csirke', NULL),
(79, 'metélőhagyma', NULL),
(80, 'zöldborsó', NULL),
(81, 'lazacfilé', NULL),
(82, 'citrom', NULL),
(83, 'sertésszűz', NULL),
(84, 'cukkini', NULL),
(85, 'kaliforniai paprika', NULL),
(86, 'padlizsán', NULL),
(87, 'olívaolaj', NULL),
(88, 'vanília aroma', NULL),
(89, 'vörösbor', NULL),
(90, 'csiperkegomba', NULL),
(91, 'darált sertéshús', NULL),
(92, 'fejes káposzta', NULL),
(93, 'savanyú káposzta', NULL),
(94, 'kacsacomb', NULL),
(95, 'kacsamell', NULL),
(96, 'citromhéj', NULL),
(97, 'bélszín', NULL),
(98, 'marhapofa', NULL),
(99, 'mandulaliszt', NULL),
(100, 'instant kávé', NULL),
(101, 'mustár', NULL),
(102, 'szódabikarbóna ', NULL),
(103, 'mézeskalács fűszerkeverék', NULL);
...
(8, 'Zöldségleves', 'ZoldsegLeves.webp', '01:00:00', 2, 15, 4, 'A zöldségeket, vagyis a sárgarépát, fehérrépát, karalábét, zellert és hagymát tisztítsd meg, majd vágd őket nagyjából egyforma méretű kockákra vagy karikákra, hogy egyszerre puhuljanak meg, a hagymát pedig hagyd egészben vagy vágd félbe.\r\n\r\nEgy nagyobb lábasban melegítsd fel az olajat közepes lángon ügyelve rá, hogy ne füstöljön, majd tedd bele a hagymát és a keményebb gyökérzöldségeket, mint a répát, zellert és fehérrépát.\r\n\r\nPárold őket néhány percig időnként megkeverve, amíg a hagyma üveges lesz és a zöldségek enyhén megpuhulnak, mert ez a lépés adja meg a leves mély ízét.\r\n\r\nÖntsd fel az egészet bőséges mennyiségű hideg vízzel a tisztább lé érdekében, majd add hozzá a csokorba kötött petrezselyem szárát, a babérleveleket, a sót és az egész borsot, utóbbit célszerű teatojásba tenni, hogy később ne zavarjon evés közben.\r\n\r\nForrald fel a levest, majd vedd vissza a lángot alacsonyra, hogy csak éppen gyöngyözzön, és fedő nélkül vagy félig lefedve főzd addig, amíg a gyökérzöldségek már majdnem puhák és villával könnyen átszúrhatók.\r\n\r\nEkkor add hozzá a karalábét is, és főzd tovább a levest, amíg minden összetevő tökéletesen puha lesz, de még nem esik szét.\r\n\r\nA főzés végén vedd ki a petrezselyem szárát, a babérlevelet és az egészben hagyott hagymát, majd szórd meg a levest frissen aprított petrezselyemmel.\r\n\r\nVégezetül kóstold meg, szükség szerint ízesítsd utána, és forrón tálald.\r\nForrald fel a levest, majd vedd vissza a lángot alacsonyra, hogy csak éppen gyöngyözzön, és fedő nélkül vagy félig lefedve főzd addig, amíg a gyökérzöldségek már majdnem puhák és villával könnyen átszúrhatók. \r\n\r\nEkkor add hozzá a karalábét is, és főzd tovább a levest, amíg minden összetevő tökéletesen puha lesz, de még nem esik szét. A főzés végén vedd ki a petrezselyem szárát, a babérlevelet és az egészben hagyott hagymát, majd szórd meg a levest frissen aprított petrezselyemmel. \r\n\r\nVégezetül kóstold meg, szükség szerint ízesítsd utána, és forrón tálald.', 4, 1, 11, 100.00),
...
(21, 'Milánói sertésborda', 'MilanoiSertesborda.webp', '00:40:00', 4, 20, 1, 'A sertéshús szeleteket fektesd egy deszkára, és egy klopfoló segítségével óvatosan ütögesd át őket, hogy mindenhol egyenletesen vékonyak legyenek, majd mindkét oldalukat alaposan szórd meg sóval és borssal.\r\n\r\nKészíts elő három mélyebb tálat a panírozáshoz: az elsőbe szitálj lisztet, a másodikba üsd bele a tojásokat és verd fel őket egy villával, a harmadikba pedig tölts bőségesen zsemlemorzsát.\r\n\r\nA húsokat forgasd meg először a lisztben, majd mártsd bele a felvert tojásba, végül pedig alaposan nyomkodd bele a zsemlemorzsába, ügyelve arra, hogy a panír minden apró részt teljesen és egyenletesen befedjen.\r\n\r\nEgy serpenyőben hevíts fel bőséges mennyiségű étolajat közepes lángon, és ellenőrizd a hőfokot egy kevés morzsával; ha azonnal pezsegni kezd, óvatosan helyezd bele a panírozott szeleteket.\r\n\r\nSüsd a húsokat türelmesen mindkét oldalukon néhány percig, amíg a panír gyönyörű aranybarna és ropogós nem lesz, majd szedd ki őket papírtörlőre, hogy a felesleges olaj lecsepeghessen róluk.\r\n\r\nA körethez egy nagyobb lábasban forralj fel vizet egy kevés sóval, majd tedd bele a spagetti tésztát, és főzd addig, amíg kellemesen ruganyos állagú nem lesz, végül szűrd le alaposan.\r\n\r\nA mártáshoz egy kisebb edényben melegítsd fel a paradicsomszószt, add hozzá a vékony csíkokra vágott sonkát, és forrald össze őket, hogy az ízek jól összeérjenek.\r\n\r\nA tálaláshoz halmozd a kifőtt tésztát a tányérra, merj rá bőségesen a sonkás paradicsomszószból, majd helyezd a tetejére a frissen sült, ropogós rántott húst.', 1, 3, 1, 850.00),
...
(39, 'Brassói aprópecsenye', 'BrassoiApropecsenye.webp', '01:00:00', 7, 30, 3, 'A sertéshúst mosd meg, töröld szárazra, majd kockákra vágd fel.\r\nEgy serpenyőben hevíts kevés olajat közepes lángon.\r\nAdd hozzá a húst, és pirítsd addig, amíg kifehéredik és enyhén megpirul.\r\nSózd és borsozd ízlés szerint, majd fedd le, és kis lángon párold 25–30 percig, amíg a hús teljesen megpuhul.\r\nHa szükséges, adj hozzá 1–2 evőkanál vizet, de ne legyen szaftos.\r\nKözben a krumplit hámozd meg, mosd meg, majd kockázd fel.\r\nEgy másik serpenyőben vagy lábasban hevíts bő olajat.\r\nSüsd ki benne a krumplit aranybarnára, majd szedd ki papírtörlőre, hogy a felesleges olaj lecsepegjen.\r\nAmikor a hús puha, add hozzá a zúzott fokhagymát, és keverd át.\r\n A fokhagymát mindig a végén add hozzá, hogy ne égjen meg és ne legyen keserű.\r\nAdd hozzá a sült krumplit, majd óvatosan forgasd össze a hússal.\r\nKóstold meg, szükség szerint sózd még.\r\n', 1, 3, 1, 750.00),
(40, 'Töltött csirkecomb', 'ToltottCsirkeComb.webp', '01:00:00', 7, 30, 2, 'A csirkecomb bőrét az ujjaddal óvatosan lazítsd fel és emeld meg, hogy egy tágas zsebet képezz a hús és a bőr között, majd alaposan sózd és borsozd meg a húst kívül és belül is.\r\n\r\nA töltelékhez vágd egészen apróra a zöldpaprikát és a paradicsomot, majd egy tálban dolgozd össze ezeket a sajttal és a sonkával, hogy egy sűrű masszát kapj.\r\n\r\nA kész tölteléket egy kanál vagy a kezed segítségével óvatosan töltsd a bőr alá képzett zsebbe, majd simítsd el, hogy egyenletesen eloszoljon a comb felületén.\r\n\r\nEgy tepsit kenj ki alaposan a sertészsírral, fektesd bele a megtöltött combokat egymás mellé, és ha maradt még paprikád vagy paradicsomod, azt is melléjük dobhatod a tepsibe.\r\n\r\nTedd a húst a sütőbe, és süsd 180°C-on hosszabb ideig, amíg a csirkecomb teljesen át nem sül és a hús meg nem puhul a csont mellett is.\r\n\r\nA sütés utolsó szakaszában addig hagyd bent, amíg a csirke bőre a sertészsírtól és a hőtől gyönyörűen megpirul és szép ropogós lesz.\r\n', 6, 3, 1, 680.00),
(41, 'Hagymás rostélyos', 'HagymasRostelyos.webp', '00:40:00', 7, 30, 2, 'A marhahús szeleteket készítsd elő, és mindkét oldalukat alaposan szórd meg sóval és borssal ízlés szerint.\r\n\r\nEgy serpenyőben forrósítsd fel az olajat, majd a húsok mindkét oldalát süsd át hirtelen, hogy szép kérget kapjanak (közepes átsütéshez elég oldalanként néhány perc).\r\n\r\nMiután a hús átsült, vedd ki a serpenyőből és pihentesd, a vöröshagymát pedig tisztítsd meg és vágd szép, egyenletes karikákra.\r\n\r\nUgyanabba a serpenyőbe, amiben a hús sült, dobd bele a hagymakarikákat, hogy átvegyék a hús szaftos ízét.\r\n\r\nA hagymakarikákat lassú tűzön, folyamatos kevergetés mellett türelmesen párold és süsd addig, amíg gyönyörű aranybarnára nem karamellizálódnak.\r\n\r\nVégezetül a sült marhahúst helyezd egy tálra, és a tetejét halmozd el gazdagon a forró, édeskés sült hagymával.', 1, 3, 1, 720.00),
(42, 'Képviselőfánk', 'KepviseloFank.webp', '01:30:00', 7, 25, 12, 'A vizet a vajjal és egy csipet sóval forrald fel teljesen, amíg a vaj elolvad és a víz lobogni kezd, majd ekkor a lisztet egyszerre add hozzá, és mérsékelt lángon addig keverd a fakanállal, amíg a tészta egyetlen gombóccá áll össze és elválik az edény falától. \r\nVedd le a tűzről, és hagyd hűlni néhány percig, hogy csak langyos legyen, majd a tojásokat egyesével keverd hozzá, minden egyes darab után megvárva, amíg a tészta teljesen felveszi az előzőt, és szép fényes masszát kapsz. \r\nNyomózsák vagy két kanál segítségével formázz kis halmokat a sütőpapírra, hagyva köztük bőven helyet, mert sokat nőnek majd.Végül süsd őket 230°C-on öt percig, majd 200°C-on további öt-tíz percig úgy, hogy a sütő ajtaját végig tilos kinyitni, különben a fánkok azonnal összeesnek.\r\nA vaníliakrémhez a vaníliás pudingport keverd el a tejjel és ízlés szerinti cukorral, majd lassú tűzön, folyamatos kevergetés mellett főzd egészen sűrűre, és hagyd teljesen kihűlni.\r\nA habtejszínt jól behűtve verd fel kemény habbá, hogy stabilan megálljon a fánkban.\r\nA kihűlt fánkok tetejét vágd le, az üreges belsejüket töltsd meg alul a sűrű vaníliapudinggal, halmozd rá a felvert tejszínhabot, végül helyezd vissza a tészta tetejét díszítésként.\r\n', 6, 3, 7, 220.00),
(43, 'Profiterol', 'Profiterol.webp', '01:00:00', 7, 25, 4, 'Égetett tészta elkészítése:\r\nA vizet, a vajat és a sót egy lábasban forrald fel.\r\nVedd le a tűzről, add hozzá egyszerre a lisztet, majd gyors mozdulatokkal keverd csomómentesre.\r\nTedd vissza a tűzre, és keverd addig, amíg a tészta elválik az edény falától.\r\nHagyd langyosra hűlni, majd egyenként keverd bele a tojásokat.\r\nA kész tésztát habzsákba töltsd, és sütőpapírral bélelt tepsire nyomj kis golyókat.\r\nSüsd 200°C-on 20–25 percig. Sütés közben ne nyisd ki a sütőt, mert a fánkok összeesnek.\r\nHagyd teljesen kihűlni.\r\n\r\n\r\n\r\nVaníliás pudingos krém:\r\nA pudingport keverd el kevés tejjel és a cukorral.\r\nA maradék tejet forrald fel, majd főzd bele a pudingot sűrűre.\r\nHagyd teljesen kihűlni.\r\nA habtejszínt verd kemény habbá, majd óvatosan forgasd bele a kihűlt pudingba.\r\nA fánkok alját vágd meg, és töltsd meg a krémmel.\r\n\r\nCsokoládéöntet elkészítése:\r\nA tejszínt melegítsd fel egy kis lábasban, de ne forrald.\r\nAdd hozzá az apróra tört étcsokoládét, és keverd simára.\r\nKeverd bele a vajat, amíg fényes, selymes öntetet kapsz.\r\nÍzlés szerint adj hozzá cukrot.\r\nLangyosan öntsd a megtöltött profiterolokra.\r\n', 6, 3, 7, 450.00),
(44, 'Egészben sült csirke', 'EgeszbenSultCsirke.webp', '01:30:00', 8, 30, 4, 'A csirkét alaposan tisztítsd meg, majd egy papírtörlő segítségével mindenhol töröld teljesen szárazra, hogy a bőre később jól pirulhasson.\r\n\r\nA hús külsejét és a belső üregét is alaposan dörzsöld be sóval és borssal ízlés szerint, hogy a fűszerek mindenhol jól átjárják.\r\n\r\nKészítsd el a fűszervajat: a puha vajat keverd össze az apróra vágott metélőhagymával és snidlinggel, amíg egyenletes masszát nem kapsz.\r\n\r\nA csirke mellénél óvatosan nyúlj a bőr alá az ujjaddal, képezz egy kis zsebet, és ide töltsd be a zöldfűszeres vajat, majd egyengesd el a bőr alatt.\r\n\r\nA csirke külsejét vékonyan kend át étolajjal, ami segít abban, hogy sütés közben egyenletesen és gyönyörű aranybarnára süljön a bőre.\r\n\r\nHelyezd a befűszerezett madarat egy tepsibe vagy sütőrácsra, majd tedd be a sütőbe.\r\n\r\nSüsd a húst 180°C-on türelmesen, amíg a bőre mindenhol ropogós lesz, a húsa pedig teljesen átpuhul a csontok mellett is.\r\n\r\nHa van maghőmérőd, ellenőrizd a comb legvastagabb részét; a hús akkor készült el tökéletesen, ha belső hőmérséklete 80-85°C körül mozog.\r\n\r\nA sütés után hagyd a csirkét pihenni a deszkán, mielőtt elkezdenéd felszeletelni, hogy a szaftok egyenletesen eloszoljanak a húsban, majd forrón tálald.', 6, 3, 1, 520.00),
...
(46, 'Sertésszűz baconbe tekerve', 'SertesszuzBaconbeTekerve.webp', '00:45:00', 8, 30, 2, 'A sertésszüzet sózd és borsozd (óvatosan, mert a bacon is sós).\r\nFektesd ki a baconcsíkokat, és helyezd rá a húst.\r\nTekerd fel szorosan, hogy mindenhol fedje a bacon.\r\nSüsd 180°C-on 20–25 percig, amíg a bacon megpirul.\r\nPihentesd 5 percig, majd szeleteld és tálald.\r\n', 6, 3, 1, 670.00),
(47, 'Grillezett zöldségek', 'GrillezettZoldsegek.webp', '00:20:00', 8, 30, 2, 'A cukkinit, a kaliforniai paprikát és a padlizsánt alaposan tisztítsd meg, majd vágd őket tetszés szerint karikákra vagy szép, hosszúkás szeletekre.\r\n\r\nA felszeletelt zöldségek mindkét oldalát kend meg vékonyan az olívaolajjal, hogy sütés közben ne tapadjanak le és szép színt kapjanak.\r\n\r\nSzórd meg a szeleteket enyhén sóval ízlés szerint, de vigyázz, mert a sótól a zöldségek levet ereszthetnek, ezért érdemes közvetlenül a sütés előtt fűszerezni.\r\n\r\nMelegíts fel egy grillt vagy egy grillserpenyőt jó forróra, majd fektesd bele a zöldségeket egymás mellé.\r\n\r\nSüsd a szeletek mindkét oldalát addig, amíg szép aranybarnák nem lesznek és meg nem jelennek rajtuk a jellegzetes grillcsíkok.\r\n\r\nMiután a zöldségek megpuhultak, de még tartják a tartásukat, vedd le őket a tűzről és azonnal, frissen tálald.', 1, 1, 10, 180.00),
(48, 'Egyszerű tortalap vajkrémmel', 'PiskotaVajKremmel.webp', '01:00:00', 8, 25, 8, 'A tojásokat óvatosan válaszd szét két külön tálba, majd a fehérjét verd fel egészen kemény habbá, a sárgáját pedig a cukorral keverd fehéredésig és habosra.\r\n\r\nA felvert sárgájához add hozzá a vanília aromát, majd nagyon óvatos mozdulatokkal forgasd bele a kemény fehérjehabot, ügyelve rá, hogy a levegő ne szökjön ki belőle.\r\n\r\nA masszába szitáld bele a lisztet, és finom, körkörös mozdulatokkal keverd el, amíg egynemű tésztát nem kapsz.\r\n\r\nA kész tésztát öntsd bele egy sütőpapírral bélelt tortaformába, majd simítsd el a tetejét, hogy egyenletesen süljön meg.\r\n\r\nTedd a formát a sütőbe, és süsd 180°C-on körülbelül húsz-huszonöt percig, amíg a piskóta szépen felemelkedik és ruganyos tapintású lesz.\r\n\r\nAmíg a tészta sül és hűl, készítsd el a vajkrémet: a szobahőmérsékletű vajat a porcukorral addig habosítsd gépi mixerrel, amíg könnyű, fehér és krémes állagot nem kapsz.\r\n\r\nVárj, amíg a tortalap teljesen kihűl, majd vágd ketté, töltsd meg a selymes vajkrémmel, végül kívülről is vond be vele az egész tortát.', 6, 2, 7, 350.00),
(49, 'Gyümölcsös piskótatorta', 'GyumolcsosTorta.webp', '00:45:00', 8, 25, 8, 'A tojásokat óvatosan válaszd ketté, a fehérjét verd fel egészen kemény habbá, a sárgáját pedig a cukorral keverd addig, amíg világos és habos nem lesz.\r\n\r\nA cukros sárgájához nagyon óvatos mozdulatokkal forgasd hozzá a kemény fehérjehabot, majd szitáld bele a lisztet, és finoman keverd el, hogy a tészta könnyed és levegős maradjon.\r\n\r\nÖntsd a masszát egy sütőpapírral bélelt tortaformába, egyengesd el a tetejét, majd tedd a sütőbe.\r\n\r\nSüsd a piskótát 180°C-on körülbelül húsz-huszonöt percig, amíg aranybarna lesz és a közepe is átsül, majd hagyd teljesen kihűlni.\r\n\r\nA töltelékhez a jól behűtött habtejszínt verd fel kőkeményre, a kiválasztott gyümölcsöket pedig alaposan tisztítsd meg és darabold fel ízlés szerint.\r\n\r\nA kihűlt piskótát egy éles késsel vágd kettő vagy három egyenlő lapra, hogy megtölthesd őket.\r\n\r\nAz alsó lapot kend meg gazdagon a felvert tejszínhabbal, szórj rá az aprított gyümölcsökből, majd helyezd rá a következő tésztaréteget.\r\n\r\nIsmételd meg a rétegezést, végül a torta tetejét és oldalát is vond be a maradék tejszínhabbal, és díszítsd kedved szerint a legszebb gyümölcsdarabokkal.', 6, 2, 7, 320.00),
(50, 'Vörösboros marharagu', 'VorosborosMarhaRagu.webp', '02:30:00', 9, 35, 4, '1. A marhahúst vágd nagyobb kockákra, sózd, borsozd.\r\n2. Forró lábasban kevés olajon pirítsd körbe, míg kérget kap.\r\n3. Add hozzá a felaprított zöldségeket (répa, hagyma, zeller, gomba), és pirítsd további 3–4 percig.\r\n4. Öntsd fel a vörösborral, majd főzd közepes lángon 2–3 percig, hogy az alkohol elpárologjon.\r\n5. Önts hozzá kevés vizet vagy alaplevet, csak annyit, hogy éppen ellepje.\r\n6. Fedd le, és lassú tűzön főzd 2 órán át, időnként kevergetve.\r\n7. Akkor kész, ha a hús teljesen omlós és a szaft sűrű.\r\n8. Tálald burgonyapürével, rizzsel vagy friss kenyérrel.', 5, 3, 3, 620.00),
(51, 'Töltött káposzta', 'Toltottkaposzta.webp', '02:00:00', 9, 35, 6, 'A levelek előkészítése: Egy nagy lábasban forraljunk vizet. Az édes káposzta torzsáját vágjuk körül, majd tegyük a fej káposztát a forró vízbe. Ahogy a külső levelek puhulni kezdenek, óvatosan fejtsük le őket egyesével, és tegyük félre.\r\n\r\nA töltelék összeállítása: A darált húst gyúrjuk össze a rizzsel, a sóval, a borssal és a pirospaprikával. Ha szaftosabb tölteléket szeretnénk, adjunk hozzá egy kevés paradicsomlevet is.\r\n\r\nTöltés: A káposztalevelek vastag erezetét vágjuk ki vagy klopfoljuk el. Halmozzunk a húsos masszából a levél közepére, hajtsuk rá a széleit, majd szorosan tekerjük fel.\r\n\r\nRétegezés: A savanyú káposztát kóstoljuk meg: ha túl intenzív, folyó víz alatt mossuk át. Egy mély lábas aljára terítsük le a savanyú káposzta felét, helyezzük rá szorosan a töltelékeket, majd fedjük be a maradék savanyú káposztával.\r\n\r\nFőzés: Öntsünk rá annyi vizet, amennyi éppen ellepi. Fedő alatt, lassú tűzön főzzük 1,5–2 órán át, amíg a rizs megpuhul és az ízek összeérnek.', 5, 3, 3, 700.00),
(52, 'Ropogós kacsacomb és kacsamell', 'SultKacsa.webp', '01:20:00', 9, 35, 2, 'Kacsacomb:\r\n1. A combokat sózd és borsozd be.\r\n2. Helyezd tepsibe, fedd le alufóliával.\r\n3. Süsd 160°C-on 60 percig, míg omlós nem lesz.\r\n4. Ha szeretnéd ropogósra, a végén fólia nélkül süsd további 10 percig.\r\n\r\nKacsamell:\r\n1. A bőrös oldalát irdald be, ügyelve, hogy a húsba ne vágj bele.\r\n2. Sózd, borsozd.\r\n3. Forró serpenyőben, bőrrel lefelé süsd 5–6 percig, míg aranybarna nem lesz.\r\n4. Fordítsd meg, majd további 2 percig sütöd a másik oldalát.\r\n5. Pihentesd 5 percig, majd szeleteld.', 6, 3, 1, 820.00),
(53, 'Sajttal-sonkával töltött csirkemell bundában', 'SajttalToltottCsirkeMell.webp', '00:35:00', 9, 35, 2, 'A csirkemellet tisztítsd meg, majd egy éles késsel vágj rajta egy mély, de óvatos zsebet, ügyelve arra, hogy a hús ne lyukadjon ki sehol, különben a töltelék sütés közben kifolyhat.\r\n\r\nA húst kívül és a zseb belsejében is alaposan szórd meg sóval és borssal ízlés szerint, hogy mindenhol átvegye a fűszerek ízét.\r\n\r\nA töltéshez használd a trappista sajtot és a főtt sonkát, amiket helyezz el szorosan a húsba vágott zsebben, majd nyomkodd össze a széleit, hogy a töltelék bent maradjon.\r\n\r\nKészíts elő három tálat a panírozáshoz: az elsőbe tedd a lisztet, a másodikba a felvert tojásokat egy kevés sóval, a harmadikba pedig a zsemlemorzsát.\r\n\r\nA megtöltött csirkemelleket forgasd meg először a lisztben, utána a tojásban, végül pedig alaposan nyomkodd bele a zsemlemorzsába, hogy mindenhol összefüggő kérget kapjon.\r\n\r\nEgy serpenyőben forrósíts fel bőséges mennyiségű étolajat, majd óvatosan helyezd bele a bepanírozott húsokat, és közepes lángon süsd őket minden oldalon szép aranybarnára.\r\n\r\nA kész húsokat emeld ki az olajból, fektesd őket papírtörlőre, hogy a felesleges zsiradékot lecsöpögtesd róluk, majd frissen és forrón tálald..', 8, 3, 1, 650.00),
(54, 'Csokoládé mousse', 'CsokiMousse.webp', '00:20:00', 9, 30, 4, '1. A csokoládét vízgőz felett olvaszd fel.\r\n2. A tojássárgákat keverd a meleg csokoládéhoz.\r\n3. A tejszínt verd lágy habbá.\r\n4. Forgasd óvatosan a csokihoz, hogy habos, könnyű krémet kapj.\r\n5. Töltsd poharakba, majd hűtsd legalább 2–3 órát.\r\n6. Tálaláskor díszítheted gyümölccsel vagy csokiforgáccsal.', 2, 2, 8, 380.00);
INSERT INTO `recept` (`ReceptID`, `Nev`, `Kep`, `ElkeszitesiIdo`, `NehezsegiSzintID`, `BegyujthetoPontok`, `Adag`, `Elkeszitesi_leiras`, `ElkeszitesiModID`, `ArkategoriaID`, `AlkategoriaID`, `Kaloria`) VALUES
(55, 'Tarte au citron', 'TarteAuCitron.webp', '00:40:00', 9, 30, 8, '1. Az omlós tésztához a lisztet, sütőport, sót és porcukrot keverd össze, majd morzsold el a hideg vajjal.\r\n2. Add hozzá a tojást, és gyors mozdulatokkal gyúrj belőle sima tésztát.\r\n3. Tedd a hűtőbe egy órára, hogy összeálljon a tészta.\r\n4. A tésztát nyújtsd ki és helyezd piteformába.\r\n5. Szurkáld meg villával.\r\n6. Süsd elő 180°C-on 10 percig.\r\n7. Keverd ki a citromkrémet.\r\n8. Öntsd a tésztára, majd süsd további 10 percig, amíg a krém megszilárdul.\r\n9. Hűtve szeleteld.', 6, 2, 7, 300.00),
(56, 'Wellington bélszín', 'WellingtonBelszin.webp', '01:45:00', 10, 35, 4, 'A bélszínt alaposan sózd és borsozd meg, majd egy füstölésig hevített serpenyőben minden oldalát hirtelen pirítsd körbe, hogy kapjon egy barna kérget, ami bent tartja a szaftokat.\r\n\r\nAmint kivetted a húst a serpenyőből, még forrón kend át vékonyan mustárral, hogy az ízek jól beszívódjanak, majd tedd félre pihenni és teljesen kihűlni.\r\n\r\nA gombát aprítsd egészen finomra, és egy száraz serpenyőben, közepes lángon pirítsd addig, amíg az összes nedvesség elpárolog belőle és egy sűrű gombapépet (úgynevezett duxelles-t) kapsz – ez kulcsfontosságú, hogy ne ázzon el később a tészta.\r\n\r\nEgy folpack fóliára fektesd le szorosan egymás mellé a baconszeleteket, egyenletesen kend el rajtuk a kihűlt gombapépet, majd helyezd a közepére a húst.\r\n\r\nA fólia segítségével tekerd fel a bacont a hús köré olyan szorosan, mint egy szalámit, a fólia végeit pedig csavard meg jól, majd tedd a hűtőbe pihenni, hogy a henger megdermedjen és tartsa a formáját.\r\n\r\nA hideg leveles tésztát nyújtsd ki, csomagold bele a hűtőből kivett, fóliából kicsomagolt húst, a tészta találkozásánál pedig zárd le szorosan a széleket, és a \"varrattal\", vagyis az illesztéssel lefelé fordítva helyezd a tepsire, hogy sütés közben ne nyíljon szét.\r\n\r\nA tészta tetejét kend le felvert tojással a szép színért, és ha van kedved, egy éles késsel karcolj bele díszítéseket, de vigyázz, ne vágd át teljesen a tésztát.\r\n\r\nTedd a sütőbe és süsd 200°C-on addig, amíg a tészta mindenhol egyenletesen aranybarna és ropogós nem lesz.\r\n\r\nHa tökéletes eredményt szeretnél, használj maghőmérőt a hús közepébe szúrva; a tészta alatt akkor lesz ideális a bélszín, ha a belső hőmérséklete eléri az 52-54°C körüli értéket.\r\n\r\nSzeletelés előtt mindenképpen hagyd pihenni a deszkán, hogy a húsrostok megnyugodjanak és a szaft ne folyjon ki az első vágásnál.', 6, 3, 1, 720.00),
(57, 'Sous-vide csirkemell', 'SousVideCsirke.webp', '01:10:00', 10, 35, 2, 'A csirkemellet alaposan tisztítsd meg, majd szórd meg sóval és borssal minden oldalát, végül helyezd egy vákuumtasakba egy kevés olaj társaságában.\r\n\r\nZárd le a tasakot vákuumozó géppel, majd helyezd a sous-vide készülékkel előmelegített vízfürdőbe, és tartsd pontosan 63°C-on egy teljes órán keresztül, hogy a hús tökéletesen pasztörizált és omlós legyen.\r\n\r\nMiután lejárt az idő, vedd ki a húst a tasakból, töröld szárazra, és egy füstölésig hevített serpenyőben mindkét oldalát hirtelen pirítsd meg fél-egy perc alatt, hogy kapjon egy vékony, ropogós kérget.\r\n\r\nHa nincs speciális géped, a fűszerezett csirkemellet egy kevés olívaolajon, közepes lángon kezdd el sütni a serpenyőben, amíg minden oldala fehéredni és pirulni nem kezd.\r\n\r\nÖnts alá egy kevés vizet vagy alaplevet, fedd le szorosan egy fedővel, és alacsony lángon párold tovább türelmesen, hogy a hús belül is biztonságosan átforrósodjon, de ne száradjon ki.\r\n\r\nA sütés végén vedd le a fedőt, és rövid ideig emeld meg a hőt, hogy a maradék nedvesség elpárologjon, és a csirke külseje újra visszakapja az aranybarna színét.\r\n\r\nA biztonságos fogyasztáshoz használj maghőmérőt: szúrd a szonda hegyét a csirkemell legvastagabb pontjába, és akkor tekintsd késznek, ha a belső hőmérséklet elérte a 75°C-ot, ami garantálja, hogy a hús átsült.\r\n\r\nMielőtt felszeletelnéd, mindenképpen hagyd pihenni a húst a vágódeszkán néhány percig, hogy a rostok ellazuljanak, és a szaft ne távozzon el a szeleteléskor.', 5, 1, 1, 240.00),
(58, 'Vörösboros marhapofa pürével', 'VorosborosMarhaPofaKrumpliPurevel.webp', '03:20:00', 10, 35, 2, 'Kéregsütés: A marhapofát tisztítsuk meg, sózzuk és borsozzuk. Egy forró serpenyőben, kevés olajon minden oldalát süssük hirtelen barnára (koncentrálva az ízekre), majd emeljük ki a húst.\r\n\r\nZöldségalap: A visszamaradt zsiradékon pirítsuk meg a finomra aprított hagymát, a kockázott sárgarépát és a zellert.\r\n\r\nPárolás: Helyezzük vissza a húsokat, öntsük fel a vörösborral és az alaplével. Fedő alatt, egészen alacsony lángon (vagy 150°C-os sütőben) pároljuk 2,5–3 órán át, amíg a hús vajpuha nem lesz.\r\n\r\nA püré: Közben a burgonyát kockázzuk fel, sós vízben főzzük puhára, majd szűrjük le. Még melegen törjük át, dolgozzuk bele a vajat és a meleg tejet, amíg krémes állagot nem kapunk.\r\n\r\nTálalás: Az omlós húst emeljük ki a mártásból. A szaftot igény szerint szűrjük le vagy pürésítsük a zöldségekkel a sűrűbb állagért. A húst szeletelve vagy szálaira tépve, a halmozott püré mellett, a gazdag mártással leöntve tálaljuk.', 5, 3, 3, 780.00),
(59, 'Házi gnocchi', 'Gnocchi.webp', '00:45:00', 10, 35, 4, 'A burgonyát mossuk meg, majd héjában főzzük puhára sós vízben. Szűrjük le, hagyjuk kicsit hűlni, majd tisztítsuk meg és törjük össze.\r\n\r\nEgy tálban keverjük össze az összetört krumplit, a tojást és a sót. Fokozatosan adjuk hozzá a lisztet, és gyúrjuk lágy, de formázható tésztává. Ha túl ragadósnak találjuk, adhatunk hozzá még egy kevés lisztet.\r\n\r\nOsszuk a tésztát több részre, és lisztezett felületen sodorjunk belőle kb. 2 cm vastag hengereket. Vágjuk fel a hengereket 2 cm-es darabokra.\r\n\r\nA darabokat villával nyomjuk meg egy kicsit, hogy jellegzetes mintát kapjanak.\r\n\r\nEgy nagy lábasban forraljunk sós vizet, és tegyük bele a gnocchikat. Főzzük 2-3 percig, amíg feljönnek a víz tetejére. Szűrjük le.\r\n\r\nEgy serpenyőben olvasszunk vajat, és pirítsuk meg benne a gnocchikat, amíg aranybarnák nem lesznek.', 4, 1, 3, 280.00),
(60, 'Macaron', 'Macaron.webp', '01:00:00', 10, 30, 15, 'A mandulalisztet és a porcukrot szitáld össze egy finom szűrőn, hogy a nagyobb szemcsék ne rontsák el a sütemény sima felületét, majd tedd félre a keveréket.\r\n\r\nA tojásfehérjét kezdd el verni, és amikor már habos, fokozatosan add hozzá a kristálycukrot, amíg egy egészen kemény, fényes és stabil habot nem kapsz; akkor jó, ha a tálat megfordítva a hab meg sem mozdul.\r\n\r\nA mandulás keveréket két-három részletben szórd a habhoz, és ekkor következik a legfontosabb rész, a „macaronage”: egy spatulával határozott, de óvatos mozdulatokkal keverd és forgasd a masszát a tál falához nyomva.\r\n\r\nAddig folytasd ezt a folyamatot, amíg a tészta sűrűn, szalagszerűen nem folyik le a spatuláról; ha túl sűrű, repedni fog, ha túl híg, szétfolyik a tepsiben, ezért a megfelelő állag elérése kulcsfontosságú.\r\n\r\nHa szeretnéd színesre, az ételfestéket még a keverés korai szakaszában add hozzá, hogy ne keverd túl a tésztát a végén.\r\n\r\nNyomózsák segítségével nyomj egyforma, apró korongokat a sütőpapírral bélelt tepsire, majd a tepsi alját néhányszor határozottan üsd oda a konyhapulthoz, hogy a légbuborékok távozzanak.\r\n\r\nHagyd a macaronokat pihenni a konyhában, amíg a tetejük „megbőrösödik”, azaz ha ujjaddal óvatosan megérinted, már nem ragad; ez a folyamat a páratartalomtól függően tarthat rövidebb vagy hosszabb ideig is.\r\n\r\nTedd a tepsit a sütőbe, és süsd a korongokat 150°C-on, amíg kialakul a jellegzetes kis „talpuk”, a tetejük pedig szilárddá válik, de ügyelj rá, hogy ne barnuljanak meg.\r\n\r\nAmíg a sütemény hűl, a vajat a porcukorral és egy kevés tejjel keverd ki egészen habos és könnyű krémmé a töltéshez.\r\n\r\nA teljesen kihűlt macaronokat óvatosan válaszd le a papírról, töltsd meg őket a krémmel, és ragaszd össze őket.', 6, 2, 7, 110.00),
(61, 'Opera szelet', 'OperaSzelet.webp', '03:15:00', 10, 30, 8, 'A piskótához a tojásokat a porcukorral és a mandulaliszttel keverd egészen habosra, majd egy másik tálban a tojásfehérjét a kristálycukorral verd kőkemény habbá, és óvatos mozdulatokkal forgasd össze a két masszát, végül csorgasd hozzá az olvasztott vajat is.\r\n\r\nA tésztát simítsd el vékony rétegben egy sütőpapírral bélelt tepsiben, és süsd 180°C-on körülbelül nyolc-tíz percig, amíg aranybarna lesz, majd miután kihűlt, vágd három pontosan egyforma méretű lapra.\r\n\r\nA kávés sziruphoz a vizet a cukorral és az erős kávéval forrald fel egy kis lábasban, majd vedd le a tűzről és hagyd teljesen kihűlni, hogy a piskóta ne ázzon el tőle.\r\n\r\nA kávés vajkrém alapjához a cukrot és a vizet kezdd el főzni egy magasabb falú edényben; nagyon vigyázz, mert a forró cukorszirup súlyos égési sérüléseket okozhat, ezért soha ne érj bele kézzel!\r\n\r\nA szirupot 118°C-ig kell hevítened, amit maghőmérővel ellenőrizhetsz, de ha nincs műszered, végezz „puha golyó” próbát: cseppents egy keveset a szirupból jéghideg vízbe, és ha az ujjaid között egy puha, formázható golyóvá áll össze, akkor elkészültél.\r\n\r\nMiközben a szirup fő, a tojássárgákat verd habosra, majd nagyon lassan, vékony sugárban csorgasd hozzá a forró cukrot folyamatos keverés mellett, és addig verd tovább a géppel, amíg a massza teljesen ki nem hűl, végül dolgozd bele a puha vajat és a kávét is.\r\n\r\nA ganache-hoz a tejszínt melegítsd fel forráspontig, majd törd bele az aprított csokoládét, és várj egy percet, mielőtt fényesre és teljesen simára kevernéd az egészet.\r\n\r\nAz összeállításnál az első piskótalapot alaposan locsold meg a kávés sziruppal, kend rá a kávés vajkrém felét, majd jöhet a második lap, amit szintén áztass be sziruppal, és simítsd rá a csokoládés ganache-t.\r\n\r\nHelyezd rá az utolsó piskótalapot, ezt is kend le sziruppal, majd vond be a maradék kávés vajkrémmel, és ügyelj rá, hogy a felülete teljesen egyenes és sima legyen.\r\n\r\nA mázhoz a csokoládét az olajjal együtt gőz felett vagy alacsony fokozaton olvaszd fel, majd egy határozott mozdulattal simítsd a sütemény tetejére, hogy tükörsima felületet kapj.\r\n\r\nA kész süteményt tedd a hűtőbe legalább két órára, hogy a rétegek megdermedjenek és az ízek összeérjenek, végül forró vízbe mártott, megtörölt éles késsel szeleteld fel elegáns téglalapokra.', 6, 3, 7, 480.00);
...
--
ALTER TABLE `felhasznalo`
  MODIFY `FelhasznaloID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT a táblához `hozzavalo`
--
ALTER TABLE `hozzavalo`
  MODIFY `HozzavaloID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=104;
