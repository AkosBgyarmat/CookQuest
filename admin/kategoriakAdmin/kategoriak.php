...
<main class="flex-1 p-10" ng-controller="kategoriaController">

    <header class="flex items-center justify-between mb-10">
        <h1 class="text-3xl font-bold mb-8">Kategóriák - {{eszkozKategoria.length + receptKategoria.length}}</h1>
    </header>

    <div>
        <header class="flex items-center justify-between mb-2">
            <h3 class="text-xl font-bold">Eszköz kategóriák - {{eszkozKategoria.length}}</h3>
        </header>
    ...
    <div>
        <header class="flex items-center justify-between mb-2 mt-10">
            <h3 class="text-xl font-bold">Recept kategóriák - {{receptKategoria.length}}</h3>
        </header>
        <table class="w-full bg-white shadow rounded">
            <thead class="bg-gray-200">
                <tr>
