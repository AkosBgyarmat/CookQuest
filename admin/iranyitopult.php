...
<header class="flex items-center justify-between mb-8">
    <h1 class="text-2xl md:text-3xl font-bold">Irányítópult</h1>
</header>

<div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6">

    <!-- Receptek -->
    <div class="bg-white rounded-xl shadow-md p-6 flex items-center justify-between border-l-4 border-green-500 hover:shadow-lg transition"
    ...
    <!-- Hozzavalók -->
    <div class="bg-white rounded-xl shadow-md p-6 flex items-center justify-between border-l-4 border-purple-500 hover:shadow-lg transition"
    ...
    <!-- Eszközök -->
    <div class="bg-white rounded-xl shadow-md p-6 flex items-center justify-between border-l-4 border-orange-500 hover:shadow-lg transition"
    ...
    <!-- Felhasználók -->
    <div class="bg-white rounded-xl shadow-md p-6 flex items-center justify-between border-l-4 border-blue-500 hover:shadow-lg transition"
    ...
    <div class="bg-white rounded-xl shadow-md p-6 flex items-center justify-between border-l-4 border-green-500 hover:shadow-lg transition"
        ...
        <div>
            ...
            <h2 class="text-3xl font-bold">{{orszag.length}}</h2>
        </div>
    ...
    <!-- HELY EXTRA STATISZTIKÁNAK -->
    <div class="bg-white rounded-xl shadow-md p-6 flex items-center justify-between border-l-4 border-purple-500 hover:shadow-lg transition">
        <div>
            <p class="text-gray-500 text-sm">További stat</p>
            <h2 class="text-3xl font-bold">--</h2>
        </div>

        <div class="text-3xl bg-purple-100 text-purple-600 w-12 h-12 flex items-center justify-center rounded-full">
            📊
        </div>
    </div>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8">
    ...
    <div class="bg-white rounded-xl shadow-md p-6">
        ...
        <ul class="space-y-2 text-gray-600 text-sm">
            ...
            <li>👥 Aktív felhasználók: --</li>
            <li>🍳 Legújabb recept: --</li>
        </ul>
    </div>
