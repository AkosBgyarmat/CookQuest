...
<main class="flex-1 p-6 md:p-10">
    ...
    <header class="flex items-center justify-between mb-8">
        <h1 class="text-2xl md:text-3xl font-bold">Irányító pult</h1>
    </header>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white p-6 rounded shadow text-center" ng-controller="eszkozController">
            <p class="text-gray-500">Konyhai felszerelések</p>
            <h2 class="text-2xl md:text-3xl font-bold">{{eszkozok.length}}</h2>
        </div>
